#!/bin/bash
#SBATCH --job-name=train_mil_heads_0.1
#SBATCH --output=logs/train_mil_heads_0.1%j/o.out
#SBATCH --error=logs/train_mil_heads_0.1%j/e.err
...
srun uv run scripts/train_mil.py     --emb_glob /gws/nopw/j04/iecdt/dash/birdnet-V3.0-dev/data/AnuraSet/train_test/train_0_1_scratch.txt     --strong_root /gws/nopw/j04/iecdt/dash/birdnet-V3.0-dev/data/AnuraSet/strong_labels     --poolers lme attn linsoft mean max     --epochs 40     --batch_size 32     --out_dir /gws/nopw/j04/iecdt/dash/birdnet-V3.0-dev/runs     --wandb     --wandb_project bird-mil-scratch
